		...
		Steps: []resource.TestStep{
			// Read testing
			{
				...
				Check: resource.ComposeAggregateTestCheckFunc(
					...
					resource.TestCheckResourceAttr("data.azureipam_block.test", "vnets.0.id", "/subscriptions/554a3781-68fa-4429-b46a-f86664d836b4/resourceGroups/RG-WE-ALL-COMMS-01/providers/Microsoft.Network/virtualNetworks/vnet-we-d-terratest-hub-01"),
					resource.TestCheckResourceAttr("data.azureipam_block.test", "vnets.1.id", "/subscriptions/49a789bb-9a8d-42be-8465-53aa77552366/resourceGroups/RG-WE-ALL-COMMS-01/providers/Microsoft.Network/virtualNetworks/vnet-we-a-testzavd-01"),
		...
		Steps: []resource.TestStep{
			// Read testing
			{
				...
				Check: resource.ComposeAggregateTestCheckFunc(
					...
					resource.TestCheckResourceAttr("data.azureipam_block.test", "vnets.0.subscription_id", "554a3781-68fa-4429-b46a-f86664d836b4"),
					resource.TestCheckResourceAttr("data.azureipam_block.test", "vnets.0.tenant_id", "562871ed-4b14-46b8-899a-0c5ffa5e4272"),
					...
					resource.TestCheckResourceAttr("data.azureipam_block.test", "vnets.1.subscription_id", "49a789bb-9a8d-42be-8465-53aa77552366"),
					resource.TestCheckResourceAttr("data.azureipam_block.test", "vnets.1.tenant_id", "562871ed-4b14-46b8-899a-0c5ffa5e4272"),
